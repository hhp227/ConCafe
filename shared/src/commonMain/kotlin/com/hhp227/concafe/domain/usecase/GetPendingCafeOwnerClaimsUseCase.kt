...
class GetPendingCafeOwnerClaimsUseCase(
    private val authRepository: AuthRepository,
    private val cafeOwnerClaimRepository: CafeOwnerClaimRepository
) {
    suspend operator fun invoke(): AppResult<List<PendingCafeOwnerClaimPreview>> {
        return try {
            ...
            if (currentUser.role != UserRole.ADMIN) {
                ...
                AppResult.Success(cafeOwnerClaimRepository.getPendingCafeOwnerClaims())
            }
