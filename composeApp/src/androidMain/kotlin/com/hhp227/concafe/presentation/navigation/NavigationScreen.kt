...
fun NavigationScreen(
    ...
    NavHost(
        ...
        composable<Route.CafeEvent> { backStackEntry ->
            val route = backStackEntry.toRoute<Route.CafeEvent>()
        ...
        composable<Route.CastList> { backStackEntry ->
            val route = backStackEntry.toRoute<Route.CastList>()
