...
private val composeAppPresentationModule = module {
    ...
    factory { AdminOperationsViewModel(get(), get(), get(), get(), get(), get(), get()) }
    ...
    factory { (cafeId: String) -> CafeDashboardViewModel(cafeId, get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get()) }
